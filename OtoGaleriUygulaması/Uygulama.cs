...
namespace OtoGaleriUygulaması
{
    class Uygulama
    {
        ...
        public void Calistir()
        {
            ...
            // Çalıştır metodu oluşturarak oluşturduğumuz metodlar ile switch case yapısı ile kullanıcıya seçim yaptırarak işlem sağlatıyoruz.
        ...
        public void ArabaKirala()
        {
            ...
            while (true)
            {
                // Kullanıcıdan almış olduğumuz plaka verisi oluşturduğumuz kiralamakontrol metodu ile doğru plaka girip girmediği ve bu arabanın olup olmadığını kontrol ediyoruz.
                // sayial metodu ile kullanıcının girdiği verinin sadece sayı girip girmediği kontrol edilip eğer harf girişi yaptıysa hata döndürüp tekrar giriş istiyoruz.
        ...
        public void YeniAraba()
        {
            ...
            while (true)
            {
                ...
                if (OtoGaleri.DurumGetir(plaka) != DURUM.Empty) // Eğer koşul sağlanıyoruz galeride böyle bir araba kayıtlıdır tekrar bilgi alınır.
                {
